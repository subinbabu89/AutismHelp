...
class PuzzlePiece {
     ...
     * this distance.
     */
    private final static float SNAP_DISTANCE = 0.05f;

    PuzzlePiece(Context context, int id, float finalX, float finalY) {
        this.finalX = finalX;
        this.finalY = finalY;
        this.id = id;
     ...
     */
    void draw(Canvas canvas, int marginX, int marginY, int puzzleSize, float scaleFactor) {
        canvas.save();
     ...
     */
    boolean hit(float testX, float testY, int puzzleSize, float scaleFactor) {
